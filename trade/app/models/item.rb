module Models
  class Item
    ...
    @@item_count = 0
    attr_accessor :name, :price, :owner, :active, :image
    attr_reader :id
    ...
    def self.named(name, price, image, owner)
      item = self.new(name, price, image, owner)
      item
    end
    ...
    def initialize(name, price, image, owner)
      self.price = price
      self.owner = owner
      self.name = name
      self.image = image
