...
class App < Sinatra::Base
  ...
  configure :development do
    ...
    user1 = overlay.new_user "Hat_man", "pwHatman", "hatman@udontsay.org", "Hats"
    ...
    user3 = overlay.new_user "Darth_Vader", "pwDarthVader", "lord.vader@imperium.com", "Force"
    ...
    user2 = overlay.new_user "ese", "pwese", "kenneth.radunz@web.de", "Computer science and stuff"
    ...
    user4 = overlay.new_user "Steve", "pwSteve", "steve@myblock.org", "Blocks o.O"
